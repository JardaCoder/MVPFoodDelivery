...
--
--insert into restaurante (nome, taxa_frete, cozinha_id) values ('Jarda Lanches', 9.90, 1);
--insert into restaurante (nome, taxa_frete, cozinha_id) values ('Jarda Burguer', 4.90, 2);
--
