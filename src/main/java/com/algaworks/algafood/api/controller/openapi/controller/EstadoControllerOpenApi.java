...
public interface EstadoControllerOpenApi {
	...
	EstadoDto criar(@ApiParam(name = "Corpo", value = "Representação de um novo estado", required = true) EstadoInputDto estadoInputDto);
	...
	EstadoDto editar(@ApiParam(value = "ID de um estado", example = "1", required = true) Long id, 
			@ApiParam(name = "Corpo", value = "Representação de um restaurante com os novos dados", required = true)EstadoInputDto estadoInputDto);
